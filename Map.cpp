...
//insert elements individually in map with the combination of key value
//value of element
...
//insert elements in range using insert() function in map 'mymap'
...
cout<<"As mymap1 is empty so empty() function will return 1 :"<<mymap1.empty()
<<endl;
